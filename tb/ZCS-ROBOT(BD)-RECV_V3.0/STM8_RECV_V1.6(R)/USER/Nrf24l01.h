...
#define W_TX_PAYLOAD_NOACK     0xB0  //不发送ACK数据.
...
void 	TX_P_SET(const unsigned char rx_address_x[]);
void 	CLEAR_P_SET();
void 	CHECK_P0_SET();
void 	RX_P_SET();
void  RX_Mode(void);//该函数初始化NRF24L01到RX模式
